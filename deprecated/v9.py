...
class PictureGridApp:
    def __init__(self, root, image_dir, banner_path, back_button_path, selections_dir, file_names, labels, scaling_factor=1.0, loading_gif_path=None, background_path=None):
        ...
        self.square_y = (self.screen_height - self.square_size) // 2  # Y position to center the square
        ...
        if self.background_path and os.path.exists(self.background_path):
            ...
            self.background_label.place(x=0, y=0, relwidth=1, relheight=1)  # Cover the entire square frame
        else:
    ...
    def display_image_grid(self):
        images_frame = Frame(self.square_frame, bg="black", highlightthickness=0)
        ...
        for idx, image_file in enumerate(self.file_names):
            ...
            container_frame = Frame(images_frame, width=self.image_size[0], height=self.image_size[1] + 20, bg="black", highlightthickness=0)
